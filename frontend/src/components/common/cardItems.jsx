  ...
  return (
    <div key={item._id} className="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
      <div className="relative overflow-hidden bg-cover bg-no-repeat" data-te-ripple-init="" data-te-ripple-color="light">
        <img className="rounded-t-lg h-52 w-full object-center object-cover" src={item.img} alt="" />
      ...
      <div className="px-6 pt-5 pb-6">
        ...
        {item.description ? <p className="mb-4 text-[0.7rem] h-16 text-neutral-600 dark:text-neutral-200">{item.description.slice(0, 170) + '...'}</p> : null}
