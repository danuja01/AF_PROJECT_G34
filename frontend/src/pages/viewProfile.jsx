        ...
        <>
            <Layout >
                <div style={{ marginRight: "0px", marginLeft: "auto", width: "30%" }}>
                    <button style={{ marginRight: "0px", marginLeft: "0px" }} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" onClick={() => {
                        window.location.replace(`http://localhost:3000/edit-profile/${id}`);
                    }}>Manage Profile</button>

                    <button style={{ marginRight: "0px", marginLeft: "10px" }} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" onClick={() => {
